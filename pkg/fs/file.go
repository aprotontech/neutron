...
type NodeAttr struct {
	...
	ParentID    int64           `gorm:"column:parent_id;omitempty"`         // parent inode number, 0 for root
	...
	SystemExtra string          `gorm:"column:extra"`                       // file extra info for system(FileSystemExtraInfo)
}
