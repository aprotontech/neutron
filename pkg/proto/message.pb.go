...
type RemoteMessage struct {
	...
	//	*RemoteMessage_ImageRepoPageRequest
	//	*RemoteMessage_ImageRepoPageResponse
...
func (x *RemoteMessage) GetImageRepoPageRequest() *ImageRepoPageRequest {
	if x != nil {
		if x, ok := x.Payload.(*RemoteMessage_ImageRepoPageRequest); ok {
			return x.ImageRepoPageRequest
		}
	}
	return nil
}

func (x *RemoteMessage) GetImageRepoPageResponse() *ImageRepoPageResponse {
	if x != nil {
		if x, ok := x.Payload.(*RemoteMessage_ImageRepoPageResponse); ok {
			return x.ImageRepoPageResponse
		}
	}
	return nil
}
...
type RemoteMessage_ImageRepoPageRequest struct {
	ImageRepoPageRequest *ImageRepoPageRequest `protobuf:"bytes,1505,opt,name=image_repo_page_request,json=imageRepoPageRequest,proto3,oneof"`
}

type RemoteMessage_ImageRepoPageResponse struct {
	ImageRepoPageResponse *ImageRepoPageResponse `protobuf:"bytes,1506,opt,name=image_repo_page_response,json=imageRepoPageResponse,proto3,oneof"`
}
...
func (*RemoteMessage_ImageRepoPageRequest) isRemoteMessage_Payload() {}

func (*RemoteMessage_ImageRepoPageResponse) isRemoteMessage_Payload() {}
...
const file_message_proto_rawDesc = "" +
	...
	"\adetails\x18\x03 \x01(\v2\x17.google.protobuf.StructR\adetails\"\xef\x11\n" +
	...
	"\x1bimage_repo_history_response\x18\xe0\v \x01(\v2!.neutron.ImageRepoHistoryResponseH\x00R\x18imageRepoHistoryResponse\x12W\n" +
	"\x17image_repo_page_request\x18\xe1\v \x01(\v2\x1d.neutron.ImageRepoPageRequestH\x00R\x14imageRepoPageRequest\x12Z\n" +
	"\x18image_repo_page_response\x18\xe2\v \x01(\v2\x1e.neutron.ImageRepoPageResponseH\x00R\x15imageRepoPageResponse\x12f\n" +
...
var file_message_proto_goTypes = []any{
	...
	(*ImageRepoPageRequest)(nil),          // 10: neutron.ImageRepoPageRequest
	(*ImageRepoPageResponse)(nil),         // 11: neutron.ImageRepoPageResponse
...
var file_message_proto_depIdxs = []int32{
	...
	10, // 9: neutron.RemoteMessage.image_repo_page_request:type_name -> neutron.ImageRepoPageRequest
	11, // 10: neutron.RemoteMessage.image_repo_page_response:type_name -> neutron.ImageRepoPageResponse
...
func file_message_proto_init() {
	...
	file_message_proto_msgTypes[1].OneofWrappers = []any{
		...
		(*RemoteMessage_ImageRepoPageRequest)(nil),
		(*RemoteMessage_ImageRepoPageResponse)(nil),
